...
proc create_root_design { parentCell } {
  ...
  set swsbtnsdd_8bit [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 swsbtnsdd_8bit ]
  ...
  # Create instance: sws_8bit, and set properties
  set sws_8bit [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 sws_8bit ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins sws_8bit/S_AXI]
  ...
  connect_bd_intf_net -intf_net sws_8bit_GPIO [get_bd_intf_ports swsbtnsdd_8bit] [get_bd_intf_pins sws_8bit/GPIO]

  # Create port connections
  connect_bd_net -net btns_5bit_ip2intc_irpt [get_bd_pins btns_5bit/ip2intc_irpt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins btns_5bit/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins sws_8bit/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins btns_5bit/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins sws_8bit/s_axi_aresetn]
  connect_bd_net -net sws_8bit_ip2intc_irpt [get_bd_pins sws_8bit/ip2intc_irpt] [get_bd_pins xlconcat_0/In0]
  ...
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs sws_8bit/S_AXI/Reg] -force
