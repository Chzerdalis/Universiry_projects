...
################################################################
# This is a generated script based on design: lab2_simple_arm
#
...
# source lab2_simple_arm_script.tcl
...
set design_name lab2_simple_arm
...
proc create_root_design { parentCell } {
  ...
  set swsbtnsdd_8bits [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 swsbtnsdd_8bits ]
  ...
  set leds_AXI_0 [ create_bd_port -dir O -from 7 -to 0 leds_AXI_0 ]

  # Create instance: adder_ip_0, and set properties
  set adder_ip_0 [ create_bd_cell -type ip -vlnv user.org:user:adder_ip:1.0 adder_ip_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins adder_ip_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net sw_8bit_GPIO [get_bd_intf_ports swsbtnsdd_8bits] [get_bd_intf_pins sw_8bit/GPIO]

  # Create port connections
  connect_bd_net -net adder_ip_0_a0 [get_bd_ports a0_0] [get_bd_pins adder_ip_0/a0]
  connect_bd_net -net adder_ip_0_a1 [get_bd_ports a1_0] [get_bd_pins adder_ip_0/a1]
  connect_bd_net -net adder_ip_0_an0 [get_bd_ports an0_0] [get_bd_pins adder_ip_0/an0]
  connect_bd_net -net adder_ip_0_an1 [get_bd_ports an1_0] [get_bd_pins adder_ip_0/an1]
  connect_bd_net -net adder_ip_0_b0 [get_bd_ports b0_0] [get_bd_pins adder_ip_0/b0]
  connect_bd_net -net adder_ip_0_b1 [get_bd_ports b1_0] [get_bd_pins adder_ip_0/b1]
  connect_bd_net -net adder_ip_0_c0 [get_bd_ports c0_0] [get_bd_pins adder_ip_0/c0]
  connect_bd_net -net adder_ip_0_c1 [get_bd_ports c1_0] [get_bd_pins adder_ip_0/c1]
  connect_bd_net -net adder_ip_0_d0 [get_bd_ports d0_0] [get_bd_pins adder_ip_0/d0]
  connect_bd_net -net adder_ip_0_d1 [get_bd_ports d1_0] [get_bd_pins adder_ip_0/d1]
  connect_bd_net -net adder_ip_0_e0 [get_bd_ports e0_0] [get_bd_pins adder_ip_0/e0]
  connect_bd_net -net adder_ip_0_e1 [get_bd_ports e1_0] [get_bd_pins adder_ip_0/e1]
  connect_bd_net -net adder_ip_0_f0 [get_bd_ports f0_0] [get_bd_pins adder_ip_0/f0]
  connect_bd_net -net adder_ip_0_f1 [get_bd_ports f1_0] [get_bd_pins adder_ip_0/f1]
  connect_bd_net -net adder_ip_0_g0 [get_bd_ports g0_0] [get_bd_pins adder_ip_0/g0]
  connect_bd_net -net adder_ip_0_g1 [get_bd_ports g1_0] [get_bd_pins adder_ip_0/g1]
  connect_bd_net -net adder_ip_0_leds_AXI [get_bd_ports leds_AXI_0] [get_bd_pins adder_ip_0/leds_AXI]
  connect_bd_net -net btns_5bit_ip2intc_irpt [get_bd_pins btns_5bit/ip2intc_irpt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins adder_ip_0/s00_axi_aclk] [get_bd_pins btns_5bit/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_99M/slowest_sync_clk] [get_bd_pins sw_8bit/s_axi_aclk]
  ...
  connect_bd_net -net rst_ps7_0_99M_peripheral_aresetn [get_bd_pins adder_ip_0/s00_axi_aresetn] [get_bd_pins btns_5bit/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_99M/peripheral_aresetn] [get_bd_pins sw_8bit/s_axi_aresetn]
  connect_bd_net -net sw_8bit_ip2intc_irpt [get_bd_pins sw_8bit/ip2intc_irpt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs adder_ip_0/S00_AXI/S00_AXI_reg] -force
