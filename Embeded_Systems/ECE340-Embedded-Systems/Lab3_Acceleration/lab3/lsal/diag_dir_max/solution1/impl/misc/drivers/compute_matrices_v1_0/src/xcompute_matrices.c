...
void XCompute_matrices_Set_query(XCompute_matrices *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XCompute_matrices_WriteReg(InstancePtr->Control_BaseAddress, XCOMPUTE_MATRICES_CONTROL_ADDR_QUERY_DATA, (u32)(Data));
    XCompute_matrices_WriteReg(InstancePtr->Control_BaseAddress, XCOMPUTE_MATRICES_CONTROL_ADDR_QUERY_DATA + 4, (u32)(Data >> 32));
}

u64 XCompute_matrices_Get_query(XCompute_matrices *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XCompute_matrices_ReadReg(InstancePtr->Control_BaseAddress, XCOMPUTE_MATRICES_CONTROL_ADDR_QUERY_DATA);
    Data += (u64)XCompute_matrices_ReadReg(InstancePtr->Control_BaseAddress, XCOMPUTE_MATRICES_CONTROL_ADDR_QUERY_DATA + 4) << 32;
    return Data;
}

void XCompute_matrices_Set_database(XCompute_matrices *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XCompute_matrices_WriteReg(InstancePtr->Control_BaseAddress, XCOMPUTE_MATRICES_CONTROL_ADDR_DATABASE_DATA, (u32)(Data));
    XCompute_matrices_WriteReg(InstancePtr->Control_BaseAddress, XCOMPUTE_MATRICES_CONTROL_ADDR_DATABASE_DATA + 4, (u32)(Data >> 32));
}

u64 XCompute_matrices_Get_database(XCompute_matrices *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XCompute_matrices_ReadReg(InstancePtr->Control_BaseAddress, XCOMPUTE_MATRICES_CONTROL_ADDR_DATABASE_DATA);
    Data += (u64)XCompute_matrices_ReadReg(InstancePtr->Control_BaseAddress, XCOMPUTE_MATRICES_CONTROL_ADDR_DATABASE_DATA + 4) << 32;
    return Data;
}
...
void XCompute_matrices_Set_direction_matrix(XCompute_matrices *InstancePtr, u64 Data) {
    ...
    XCompute_matrices_WriteReg(InstancePtr->Control_BaseAddress, XCOMPUTE_MATRICES_CONTROL_ADDR_DIRECTION_MATRIX_DATA, (u32)(Data));
    XCompute_matrices_WriteReg(InstancePtr->Control_BaseAddress, XCOMPUTE_MATRICES_CONTROL_ADDR_DIRECTION_MATRIX_DATA + 4, (u32)(Data >> 32));
}
...
u64 XCompute_matrices_Get_direction_matrix(XCompute_matrices *InstancePtr) {
    ...
    Data = XCompute_matrices_ReadReg(InstancePtr->Control_BaseAddress, XCOMPUTE_MATRICES_CONTROL_ADDR_DIRECTION_MATRIX_DATA);
    Data += (u64)XCompute_matrices_ReadReg(InstancePtr->Control_BaseAddress, XCOMPUTE_MATRICES_CONTROL_ADDR_DIRECTION_MATRIX_DATA + 4) << 32;
    return Data;
}
