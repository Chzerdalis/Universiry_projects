...
// ==============================================================
`timescale 1 ns / 1 ps
module compute_matrices_querry_buff_0_ram (addr0, ce0, d0, we0, q0, addr1, ce1, q1, addr2, ce2, q2, addr3, ce3, q3,  clk);
...
`timescale 1 ns / 1 ps
module compute_matrices_querry_buff_0(
    reset,
    clk,
    address0,
    ce0,
...
compute_matrices_querry_buff_0_ram compute_matrices_querry_buff_0_ram_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .we0( we0 ),
