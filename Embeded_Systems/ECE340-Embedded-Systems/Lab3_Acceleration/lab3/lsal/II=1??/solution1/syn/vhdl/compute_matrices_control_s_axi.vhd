...
architecture behave of compute_matrices_control_s_axi is
    ...
    constant ADDR_DATABASE_DATA_0         : INTEGER := 16#1c#;
    constant ADDR_DATABASE_DATA_1         : INTEGER := 16#20#;
    constant ADDR_DATABASE_CTRL           : INTEGER := 16#24#;
    ...
    signal int_database        : UNSIGNED(63 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_DATABASE_DATA_0 =>
                        rdata_data <= RESIZE(int_database(31 downto 0), 32);
                    when ADDR_DATABASE_DATA_1 =>
                        rdata_data <= RESIZE(int_database(63 downto 32), 32);
...
-- ----------------------- Register logic ----------------
    ...
    database             <= STD_LOGIC_VECTOR(int_database);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_DATABASE_DATA_0) then
                    int_database(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_database(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_DATABASE_DATA_1) then
                    int_database(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_database(63 downto 32));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_DIRECTION_MATRIX_DATA_0) then
                    int_direction_matrix(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_direction_matrix(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_DIRECTION_MATRIX_DATA_1) then
                    int_direction_matrix(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_direction_matrix(63 downto 32));
                end if;
            end if;
        end if;
    end process;
