...
HD_PWD='/home/nbellas/fpadd_arm_2/fpadd_arm_2.runs/lab2_simple_arm_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_simple_arm_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab2_simple_arm_xbar_0.tcl
