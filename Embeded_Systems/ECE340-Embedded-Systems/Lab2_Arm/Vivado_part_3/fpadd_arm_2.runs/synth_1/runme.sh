...
HD_PWD='/home/nbellas/fpadd_arm_2/fpadd_arm_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_simple_arm_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab2_simple_arm_wrapper.tcl
