...
// int AIPlayer::minimax(OthelloGame &game, int depth, bool maximizingPlayer, int alpha, int beta, int player, int Pawneval)
// {   
//     int opponent = (player == Pawn_X) ? Pawn_O : Pawn_X;
    
//     game.calculateAvailableMoves(player);
...
//                 // Make the move on a copy of the game
//             OthelloGame gameCopy(game);
//             gameCopy.makeMove(move.row, move.col, player);
//             int eval;
            
//             if (depth == 1 || game.isGameOver())
//                 eval = evaluateBoard(gameCopy, Pawneval);
//             else if(!gameCopy.hasValidMoves(opponent)) {
//                 gameCopy.calculateAvailableMoves(player);
//                 eval = minimax(gameCopy, depth - 1, maximizingPlayer, alpha, beta, player, Pawneval);
//             }else{
//                 eval = minimax(gameCopy, depth - 1, !maximizingPlayer, alpha, beta, opponent, Pawneval);
//             }
